...
export default function LoginScreen() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      // Different versions of @react-native-google-signin/google-signin return
      // different shapes: older versions resolve directly to a User object
      // with idToken at the top level; newer versions (v11+) wrap it as
      // { data: { idToken, user, ... } }. This checks both safely.
      const idToken =

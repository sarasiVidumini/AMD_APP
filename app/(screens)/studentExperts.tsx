...
export default function StudentExperts() {
  ...
  const [pendingExpert, setPendingExpert] = useState<{
    id: string;
    name: string;
  } | null>(null);
  ...
  const handleVerifyConfirm = async () => {
    ...
    setVerifying(true);
    try {
      const response = await API.post("/chat/verify-email", {
        ...
        <View style={styles.header}>
          ...
          <View style={styles.flex1}>
            ...
            <Text style={styles.subtitle}>
              Connect with Verified Academic Specialists
            </Text>
          </View>
        </View>
            ...
            <View style={styles.expertBody}>
              <View style={styles.expertTopRow}>
                ...
                <View style={styles.flex1}>
                  ...
                  <Text style={styles.expertExpertise}>
                    {exp.expertise || "Computer Science"}
                  </Text>
                  <Text style={styles.expertDept} numberOfLines={2}>
                    {exp.department}
                  </Text>
                </View>
              </View>
          ...
          <View style={styles.modalCard}>
            ...
            <View style={styles.modalBody}>
              <Text style={styles.modalDescription}>
                ...
                <Text style={styles.modalDescriptionStrong}>
                  {pendingExpert?.name}
                </Text>
                .
              </Text>
